...
class App extends Component {
  ...
  renderImagesList = () => {
    const {activeTabId, imageToBeSelected} = this.state
  ...
  renderScoreCard = () => {
    ...
    return <GameOver onClickPlayAgain={this.resetGame} score={score} />
  }
    ...
    return (
      <>
        ...
        <div className="second-container">
          {isGameOver ? this.renderScoreCard() : this.renderImagesList()}
        </div>
      </>
    )
  }
